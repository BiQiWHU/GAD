...
def rb_and_resize(img_path,img_save_path):
...
if __name__ == '__main__':
    ...
    origin_dir = 'D:/Med/dataset/DGDR/MESSIDOR2/IMAGES'
    for img in tqdm(os.listdir(origin_dir)):
        imgpath = os.path.join(origin_dir, img)
        img_save_path = os.path.join('D:/Med/dataset/DGDR/MESSIDOR2/processed', img)
        rimg, rmask = rb_and_resize(imgpath, img_save_path)
        # print('done')
